...
export default function AddReplaceStockButton({
  ...
  const stockDescription = isApprovedAlt && detail.new_material_name
    ? detail.new_material_name
    : detail.material_description;
  const stockCategory = isApprovedAlt && detail.new_category_name
    ? detail.new_category_name
    : detail.material_category;
  const stockSubcategory = isApprovedAlt && detail.new_subcategory_names?.length > 0
