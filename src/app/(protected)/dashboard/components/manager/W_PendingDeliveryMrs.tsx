...
export default function PendingDeliveryMrsWidget({ dateFrom, dateTo }: props) {
  ...
  useEffect(() => {
    const handleCloseAll = (e: Event) => {
      ...
      if (customE.detail?.source !== "pending-delivery") setShowPopup(false);
    };
  ...
  const handleMouseEnter = (e: React.MouseEvent) => {
    ...
    window.dispatchEvent(
      new CustomEvent("close-all-hover-popups", { detail: { source: "pending-delivery" } }),
    );
    cancelHideTimer();
    setShowPopup(true);
  };
  ...
  const changeText = hasNoPendingDeliveries
    ...
    : isAllTime
      ...
      : `Total pending deliveries ${filteredLabel}`;
