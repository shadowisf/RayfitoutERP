...
export default function ThreeDotsMenuButton({
  item,
}: ThreeDotsMenuButtonProps) {
  ...
  return (
    ...
    >
      ...
      {isOpen && (
        ...
        >
          <EditBoqItemButton item={item} onSuccess={() => setIsOpen(false)} />
          <DuplicateBoqItemButton
            item={item}
            onSuccess={() => setIsOpen(false)}
          />
          <DeleteBoqItemButton item={item} onSuccess={() => setIsOpen(false)} />
        </div>
      )}
    </div>
  );
